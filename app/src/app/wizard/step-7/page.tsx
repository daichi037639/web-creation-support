...
const steps = [
  ...
  },
  {
    ...
    body: '前のステップの「HTMLをダウンロード」ボタンでサイトのHTMLファイル（index.html など）を保存し、GitHubのリポジトリにドラッグ＆ドロップでアップロードしてください。',
    url: null,
    urlLabel: null,
  },
  {
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-6 px-4 py-8">
      <header className="flex flex-col gap-1">
        <p className="text-xs font-medium uppercase tracking-widest text-accent-700">STEP 7</p>
        <h1 className="text-2xl font-bold text-slate-900">サイトを公開する</h1>
      ...
      <ol className="flex flex-col gap-4">
        {steps.map((step, i) => (
          <li key={i} className="flex gap-4 rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-100">
      ...
      <div className="rounded-2xl bg-accent-50 p-6 text-center">
        <p className="text-lg font-bold text-accent-800">🎉 おめでとうございます！</p>
